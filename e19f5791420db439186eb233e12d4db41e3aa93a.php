<?php if(count($fields) === 1 && array_keys($fields)[0] === 'general'): ?>
    <router-link dusk="nova-settings" tag="h3" :to="{ name: 'nova-settings' }" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
        ...
        <span class="sidebar-label">
            <?php echo e(__('novaSettings.navigationItemTitle')); ?>
...
<?php else: ?>
    ...
    <ul class="list-reset mb-8">
        <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key === 'general'): ?>
                <li dusk="nova-settings-<?php echo e($key); ?>" class="leading-wide mb-4 text-sm">
                    <router-link :to="{ path: '/<?php echo e($basePath); ?>/<?php echo e($key); ?>' }" class="text-white ml-8 no-underline dim">
                        <?php echo e(__('novaSettings.general')); ?>
            ...
            <?php else: ?>
                <li dusk="nova-settings-<?php echo e($key); ?>" class="leading-wide mb-4 text-sm">
                    <router-link :to="{ path: '/<?php echo e($basePath); ?>/<?php echo e($key); ?>' }" class="text-white ml-8 no-underline dim">
                        <?php echo e(\OptimistDigital\NovaSettings\NovaSettings::getPageName($key)); ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\inventory\vendor\optimistdigital\nova-settings\src/../resources/views/navigation.blade.php ENDPATH**/ ?>